...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/CSLivenessFTechSDK/FaceTecSDK.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/CSLivenessSDK/CSLivenessSDK.framework"
fi
